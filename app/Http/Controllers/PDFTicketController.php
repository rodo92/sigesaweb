...
class PDFTicketController extends Controller
{
    ...
    public function detalle_factura()
    {
		...
		$this->fpdf->Cell(30,5,utf8_decode('DESCRIPCIÓN'),0,0,'L');
		...
		for ($i=0; $i < count($this->detalle); $i++) { 
			...
			$this->fpdf->Cell(30,5,utf8_decode($this->detalle[$i]['Descripcion']),'',0,'L');
